...
Lets try to reproduce the style of the admixture bar plots we saw last week.

First we need to create a matrix of data where the rows sum to 1 for each individual.
...
Extract data for AFR_ASW population, and sort it based on level of African genetic ancestry$\dots$
